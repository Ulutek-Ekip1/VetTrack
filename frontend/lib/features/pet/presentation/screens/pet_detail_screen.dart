                ...
                child: Column(
                  ...
                  children: [
                          ...
                          children: [
                            CircleAvatar(
                              ...
                              child: pet.photoUrl == null || pet.photoUrl!.isEmpty
                                  ? const Icon(Icons.pets, size: 36, color: primaryBlue)
                                  : null,
                            ),
                    ...
                    ElevatedButton.icon(
                      ...
                      label: const Text('AI Sağlık & Bakım Önerileri', style: TextStyle(fontWeight: FontWeight.bold)),
                    ),
                    ...
                    OutlinedButton.icon(
                      ...
                      label: const Text('Bilgileri Düzenle', style: TextStyle(fontWeight: FontWeight.bold)),
                    ),
                    const SizedBox(height: 12),
                    OutlinedButton.icon(
                      onPressed: () {
                      ...
                      label: const Text('Geçmiş Ziyaretler & Muayeneler', style: TextStyle(fontWeight: FontWeight.bold)),
                    ),
                    const SizedBox(height: 12),
                    OutlinedButton.icon(
                      onPressed: () {
                      ...
                      label: const Text('Tedaviler & Aşı Takvimi', style: TextStyle(fontWeight: FontWeight.bold)),
                    ),
                  ],
                ),
              );
