...
class PetRecommendationScreen extends StatefulWidget {
  ...
  @override
  State<PetRecommendationScreen> createState() => _PetRecommendationScreenState();
}
  ...
  final List<Map<String, dynamic>> _recommendations = [
    {
      ...
      'description':
          'Evcil hayvanınızın yaş ve kilo analizine göre günlük protein oranı %30 olan somonlu kuru mama kullanımı tavsiye edilir. Sıvı alımını artırmak için haftada 2 kez yaş mama verebilirsiniz.',
    ...
    },
    {
      ...
      'description':
          'Yıllık Karma Aşı zamanına 14 gün kaldı. Bağışıklık seviyesinin düşmemesi için veteriner hekiminizden randevu almayı unutmayın.',
    ...
    },
    {
      ...
      'description':
          'Mevsimsel tüy geçişlerini kolaylaştırmak ve stresi azaltmak amacıyla günlük en az 30 dakika tüy taraması ve aktif oyun tavsiye edilmektedir.',
      'actionLabel': 'Aktivite Planı',
    },
  ];
        ...
        slivers: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Row(
                            children: [
                              Icon(Icons.auto_awesome, color: theme.colorScheme.tertiary, size: 24),
          ...
          SliverToBoxAdapter(
            child: SingleChildScrollView(
              ...
              physics: const BouncingScrollPhysics(),
              padding: const EdgeInsets.only(left: AppDimensions.containerMargin, bottom: 12),
              child: Row(
                children: ['Tümü', 'Beslenme', 'Sağlık', 'Aktivite'].map((category) {
                          ...
                          Align(
                            ...
                            child: OutlinedButton(
                              ...
                              style: OutlinedButton.styleFrom(
                                ...
                                side: BorderSide(color: cardColor, width: 1.2),
                ...
                child: Column(
                  children: [
                    const Row(
                      ...
                      children: [
                        Icon(Icons.auto_awesome, color: peachText, size: 22),
                        SizedBox(width: 8),
                        Text(
